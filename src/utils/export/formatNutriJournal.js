...
import { capitalizeFirst, formatArgentinaTimestamp, formatFullDateSpanish, getTrainingContext } from './exportHelpers';
...
export const generateFoodJournal = ({
  ...
  journal += '═══════════════════════════════════════════════════════════════\n';
  journal += 'NOTAS:\n';
  journal += '- Horarios en zona horaria de Argentina (America/Argentina/Buenos_Aires)\n';
