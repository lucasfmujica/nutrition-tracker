...
export function useSupabase() {
    ...
    // CRITICAL: Memoize the facade so its identity is stable across renders.
    // useSupabase feeds ~20 downstream hooks and the TrackerContext value; an
    // unstable object here churns all of them (and broke the Vault worker timer).
    return useMemo(
        () => ({
            user,
            loading,
