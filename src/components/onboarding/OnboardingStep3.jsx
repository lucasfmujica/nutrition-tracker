...
export function OnboardingStep3({ data, handlers }) {
    ...
    <div className="space-y-5">
      ...
      <div className="mt-6 p-4 bg-gray-700/30 rounded-xl">
        ...
        <div className="grid grid-cols-2 gap-2 text-sm">
          ...
          <div className="text-white font-medium">{data.currentWeight || '-'} kg</div>
          <div className="text-gray-400">Objetivo:</div>
          <div className="text-white font-medium">{data.goalWeight || data.currentWeight || '-'} kg</div>
          <div className="text-gray-400">Calorías diarias:</div>
          <div className="text-white font-medium">{data.calorieGoal || '-'} kcal</div>
          <div className="text-gray-400">Proteína:</div>
          <div className="text-white font-medium">{data.proteinGoal || '-'}g</div>
          <div className="text-gray-400">Entrenos/semana:</div>
          <div className="text-white font-medium">{data.trainingDaysPerWeek} días</div>
        </div>
      </div>
    </div>
  );
