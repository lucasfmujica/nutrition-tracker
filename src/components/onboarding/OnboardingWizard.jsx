...
export function OnboardingWizard({ onComplete }) {
  ...
  const canProceed = () => {
    if (step === 1) return formData.currentWeight && formData.height && formData.age;
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-gray-900 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-gray-800/80 backdrop-blur-xl border border-gray-700/50 rounded-2xl p-6 shadow-2xl">
          {step === 1 && <OnboardingStep1 data={formData} handlers={handlers} />}
          {step === 2 && <OnboardingStep2 data={formData} handlers={handlers} />}
          {step === 3 && <OnboardingStep3 data={formData} handlers={handlers} />}
