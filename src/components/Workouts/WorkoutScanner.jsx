...
export const WorkoutScanner = ({ onSave, onCancel }) => {
    ...
    <div className="fixed inset-0 bg-slate-900/60 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
      <div className="bg-white rounded-3xl p-6 w-full max-w-lg border border-gray-100 shadow-2xl max-h-[90vh] overflow-y-auto flex flex-col">
        ...
        <div className="flex justify-between items-start mb-6">
          <div>
            <h2 className="text-xl font-bold text-gray-900">Importar desde Gravl</h2>
            <p className="text-sm text-gray-500">Sube capturas de tu entrenamiento</p>
          </div>
          <button
            onClick={onCancel}
        ...
        {!parsedResult ? (
          <div className="space-y-6">
            ...
            >
              ...
              <p className="font-bold text-gray-900">Toca para subir imágenes</p>
              <p className="text-xs text-gray-400 mt-1">Soporta múltiples capturas</p>
            </div>

            {/* Selected Files Preview */}
            {selectedFiles.length > 0 && (
              <div>
                <h4 className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Seleccionadas ({selectedFiles.length})</h4>
          ...
          <div className="flex flex-col flex-1 min-h-0">
            ...
            <div className="bg-amber-50 rounded-xl p-4 mb-4 flex items-start gap-3">
              ...
              <div className="text-sm text-amber-800">
                ...
                <p>Verifica que los datos sean correctos antes de guardar. Puedes editar el JSON directamente si es necesario.</p>
              </div>
            </div>
