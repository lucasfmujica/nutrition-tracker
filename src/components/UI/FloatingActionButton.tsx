        ...
        <>
            ...
            <button
                ...
                className={`fixed right-6 bottom-24 z-50 w-16 h-16 rounded-full flex items-center justify-center text-white shadow-2xl transition-all duration-300 ring-4 ring-white active:scale-90 ${
                    isOpen
                        ? 'rotate-45 bg-slate-800 shadow-slate-800/40'
                        : 'scale-100 bg-gradient-to-tr from-blue-600 to-cyan-500 hover:scale-110 hover:-translate-y-1 hover:shadow-blue-500/50 hover:shadow-2xl'
                }`}>
