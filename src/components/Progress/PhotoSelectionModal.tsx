...
import { getAngleBadge, formatAngleLabel } from '../../utils/progressUtils';
                ...
                <div className="flex-1 overflow-y-auto p-6">
                    {filteredPhotos.length === 0 ? (
                        <div className="text-center py-12">
                            <p className="text-slate-400">No hay fotos con este ángulo</p>
                        </div>
                    ) : (
