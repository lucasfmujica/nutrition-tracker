...
export const AdaptiveCaloriesBadge: React.FC<AdaptiveCaloriesBadgeProps> = ({
    ...
    return (
        <div className="flex items-center gap-2 px-3 py-1.5 bg-gradient-to-r from-fat-soft to-carbs-soft border border-warning/30 rounded-full shadow-sm">
            <div className="flex items-center justify-center w-6 h-6 bg-warning-soft rounded-full">
