...
interface FastLogCarouselProps {
    frequentFoods?: FastLogFood[];
    frequentCombos?: FastLogCombo[];
    onQuickLog: (item: any) => Promise<string | boolean>;
    userProfile?: any;
}

/**
 * FastLogCarousel - Premium Action Card Grid for quick logging.
 */
export const FastLogCarousel: React.FC<FastLogCarouselProps> = ({
    frequentFoods = [],
    frequentCombos = [],
    onQuickLog,
}) => {
    ...
    const handleLog = async (item: any, isCombo: boolean) => {
