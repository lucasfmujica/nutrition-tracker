import { Activity, BarChart2, BookOpen, Camera, Dumbbell, Footprints, Home, Import, Moon, PlusCircle, Star, Utensils } from 'lucide-react';
                ...
                {actions.map((action, i) => (
                  ...
                  >
                    ...
                    <div className="text-left min-w-0 flex-1">
                      <div className="text-sm font-bold text-gray-900 truncate">{action.label}</div>
                      <div className="text-xs text-gray-500 font-medium truncate">{action.sublabel}</div>
                    </div>
                  </button>
                ))}
              </div>
            ...
            return (
              ...
              >
                ...
                <span className={`text-[10px] font-medium mt-1 transition-all ${
                  isActive ? 'opacity-100 font-semibold' : 'opacity-80 hidden xs:block'
                }`}>
                  {tab.label}
                </span>
              </button>
