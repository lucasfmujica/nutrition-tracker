...
export const AuthRegister = ({ email, setEmail, password, setPassword, confirmPassword, setConfirmPassword, onSubmit, loading, setMode, error, message, handleGoogleSignIn, handleContinueOffline, LukenFitLogo }) => {
  return (
    <>
