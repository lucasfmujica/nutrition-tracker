...
export const MealCompassCard = ({ suggestions, onSelect }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-2xl p-5 border border-indigo-100 shadow-sm">
      <div className="flex items-center gap-2 mb-4">
        ...
        <div>
          <h3 className="font-bold text-indigo-900 leading-tight">Smart Compass</h3>
          <p className="text-xs text-indigo-600/80 font-medium">Sugerencias inteligentes para cerrar tu día</p>
        </div>
      </div>
          ...
          >
            <div className="min-w-0">
              ...
              <div className="flex items-center gap-2 text-xs text-gray-500 mt-0.5">
                ...
                <span>•</span>
                <span className="text-indigo-600 font-medium">{meal.protein}g P</span>
                <span>•</span>
