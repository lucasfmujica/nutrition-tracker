...
export const MealCompassCard: React.FC<MealCompassCardProps> = ({
    ...
    return (
        <div className="bg-primary-soft rounded-card p-5 border border-primary/20 shadow-card">
            <div className="flex items-center gap-2 mb-4">
                <div className="bg-surface p-1.5 rounded-control shadow-card">
            ...
            <div className="grid grid-cols-1 gap-3">
                {suggestions.map((meal, index) => (
                    <button
                        ...
                        className="flex items-center justify-between bg-surface p-3 rounded-control border border-border hover:border-primary/40 hover:shadow-card transition-all group text-left w-full">
